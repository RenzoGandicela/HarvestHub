...
public final class ItemUserBinding implements ViewBinding {
  ...
  private ItemUserBinding(@NonNull LinearLayout rootView, @NonNull CircleImageView profileImage,
  ...
  public static ItemUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemUserBinding((LinearLayout) rootView, profileImage, usernameText);
    }

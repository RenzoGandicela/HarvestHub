...
public final class NavHeaderBinding implements ViewBinding {
  ...
  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView emailTxt,
      @NonNull CircleImageView profileImg, @NonNull TextView userNameTxt) {
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NavHeaderBinding((LinearLayout) rootView, emailTxt, profileImg, userNameTxt);
    }

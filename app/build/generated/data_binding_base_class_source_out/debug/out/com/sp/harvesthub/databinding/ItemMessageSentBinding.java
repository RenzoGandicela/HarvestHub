...
public final class ItemMessageSentBinding implements ViewBinding {
  ...
  private ItemMessageSentBinding(@NonNull LinearLayout rootView, @NonNull ImageView messageImage,
      @NonNull TextView messageTxt, @NonNull CircleImageView profileImage,
      @NonNull TextView senderNameTxt, @NonNull TextView timestampTxt) {
  ...
  public static ItemMessageSentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageSentBinding((LinearLayout) rootView, messageImage, messageTxt,

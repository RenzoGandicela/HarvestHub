...
public final class FragmentBookmarkDetailsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentBookmarkDetailsBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentBookmarkDetailsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentBookmarkDetailsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_bookmark_details, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentBookmarkDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentBookmarkDetailsBinding((RelativeLayout) rootView, bookmarkButton,
          descriptionText, descriptionTitle, expiryDateText, foodImage, foodName, binding_halalTag,
          locationText, quantityText, sellerIdText, binding_spicyTag, undoButton, uploadTimeText);
    }

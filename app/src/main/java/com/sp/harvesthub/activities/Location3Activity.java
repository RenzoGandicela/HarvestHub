...
public class Location3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Woodlands Community Fridge");

        // Initialize Firebase Auth
        currentUser = FirebaseAuth.getInstance().getCurrentUser();
        
        // Initialize Firebase Database Reference for chat room 3 (Woodlands)
        chatDatabase = FirebaseDatabase.getInstance()
                .getReference("chats").child("chat_room_3").child("messages");
        ...
        // Update stream URL for Woodlands location
        liveCameraView.loadUrl("https://www.youtube.com/embed/woodlands_stream_id?autoplay=1&controls=0&mute=1&modestbranding=1&disablekb=1&fs=0&showinfo=0&rel=0");
        ...
        sendButton.setOnClickListener(v -> {
            ...
            if (!message.isEmpty() && currentUser != null) {
                ...
                newMessageRef.child("timestamp").setValue(System.currentTimeMillis())
                    ...
                    .addOnFailureListener(e -> Toast.makeText(Location3Activity.this, 
    ...
    private void attachDatabaseListener() {
        chatListener = new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Location3Activity.this, 

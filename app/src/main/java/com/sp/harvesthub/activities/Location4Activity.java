...
public class Location4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Teck Whye Community Fridge");

        // Initialize Firebase Auth
        currentUser = FirebaseAuth.getInstance().getCurrentUser();
        
        // Initialize Firebase Database Reference for chat room 4 (Teck Whye)
        chatDatabase = FirebaseDatabase.getInstance()
                .getReference("chats").child("chat_room_4").child("messages");
        ...
        // Update stream URL for Teck Whye location
        liveCameraView.loadUrl("https://www.youtube.com/embed/teckwhye_stream_id?autoplay=1&controls=0&mute=1&modestbranding=1&disablekb=1&fs=0&showinfo=0&rel=0");
        ...
        sendButton.setOnClickListener(v -> {
            ...
            if (!message.isEmpty() && currentUser != null) {
                ...
                newMessageRef.child("timestamp").setValue(System.currentTimeMillis())
                    ...
                    .addOnFailureListener(e -> Toast.makeText(Location4Activity.this, 
    ...
    private void attachDatabaseListener() {
        chatListener = new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Location4Activity.this, 

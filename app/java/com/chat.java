            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if ("User".equalsIgnoreCase(role)) {
                        ...
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK); // Change 1: Added flags to clear activity stack
                        startActivity(intent);
                    } else if ("Seller".equalsIgnoreCase(role)) {
                        Intent intent = new Intent(Login.this, SellerDashboard.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK); // Change 1: Added flags to clear activity stack
                        startActivity(intent);
                    }
                    finish();
